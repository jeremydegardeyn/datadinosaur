...
(function () {
  ...
  const styles = `
    ...
    #dd-chat-btn:hover { background: #059669; transform: scale(1.08); }
    ...
    .dd-msg.user { background: #10b981; color: #fff; align-self: flex-end; }
    ...
    .dd-sources a {
      display: block; color: #10b981; text-decoration: underline;
    ...
    #dd-chat-input:focus { border-color: #10b981; }
    #dd-chat-send {
    ...
    #dd-chat-send:hover { background: #059669; }
