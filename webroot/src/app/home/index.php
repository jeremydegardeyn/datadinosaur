      ...
      <div class="hero-dino-wrap">
        ...
        <svg class="hero-dino-svg" viewBox="98 218 596 138"
          ...
          <!-- Dinosaur graphic — head raises and the lower jaw chomps the falling
               numbers 3x, looping. Begins at 4.5s so the jumping letters settle first.
          ...
          <defs>
            ...
            <mask id="dino-eat-mask">
              ...
              <circle cx="258" cy="300" r="3"   fill="#000" opacity="0"><animate attributeName="opacity" from="0" to="1" begin="5.97s" dur="0.1s" fill="freeze"/></circle>
              <circle cx="265" cy="299" r="2.9" fill="#000" opacity="0"><animate attributeName="opacity" from="0" to="1" begin="6.12s" dur="0.1s" fill="freeze"/></circle>
              <circle cx="270" cy="298" r="2.9" fill="#000" opacity="0"><animate attributeName="opacity" from="0" to="1" begin="6.51s" dur="0.1s" fill="freeze"/></circle>
              <circle cx="275" cy="296" r="3"   fill="#000" opacity="0"><animate attributeName="opacity" from="0" to="1" begin="6.66s" dur="0.1s" fill="freeze"/></circle>
              <circle cx="280" cy="293" r="3.1" fill="#000" opacity="0"><animate attributeName="opacity" from="0" to="1" begin="7.05s" dur="0.1s" fill="freeze"/></circle>
              <circle cx="285" cy="291" r="3.3" fill="#000" opacity="0"><animate attributeName="opacity" from="0" to="1" begin="7.16s" dur="0.1s" fill="freeze"/></circle>
              <circle cx="291" cy="290" r="3.4" fill="#000" opacity="0"><animate attributeName="opacity" from="0" to="1" begin="7.27s" dur="0.1s" fill="freeze"/></circle>
            </mask>
          </defs>
          <g id="hero-dino-graphic">
            <animateTransform attributeName="transform" type="rotate" dur="6s" begin="4.5s" repeatCount="indefinite"
